/// @description tmc_string_is_valid_keep(string_source,string_characters_to_keep)
/// @param string_source
/// @param string_characters_to_keep
function tmc_string_is_valid_keep(argument0, argument1) {
	/*
