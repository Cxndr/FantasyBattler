/// @description tmc_string_is_valid_exclude(string_source,string_characters_to_exclude)
/// @param string_source
/// @param string_characters_to_exclude
function tmc_string_is_valid_exclude(argument0, argument1) {
	/*
