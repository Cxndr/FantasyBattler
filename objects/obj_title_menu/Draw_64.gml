...
// center menu 
x = ( camera_get_view_x(view_camera[0]) + (camera_get_view_width(view_camera[0])/2) - (width/2) ) * obj_camera.scale_factor;
y = ( camera_get_view_y(view_camera[0]) + (camera_get_view_height(view_camera[0])/2) - (height/2) ) * obj_camera.scale_factor;
